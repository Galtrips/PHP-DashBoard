...
<body>
  <div id="login-page">
    ...
    <!-- Début du formulaire -->
      <form class="form-login" method="POST" action="/traitement-form-connect.php">
        <h2 class="form-login-heading">Connexion</h2>
        <div class="login-wrap">
         
          <label for="nameInput">Votre nom</label>
          <input type="text" class="form-control" id="nameInput" name="name" placeholder="Nom d'utilisateur" autofocus>
